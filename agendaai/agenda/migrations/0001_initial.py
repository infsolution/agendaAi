# Generated by Django 2.1.7 on 2019-03-04 12:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('business', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='professionals', to='agenda.Business')),
        ...
        migrations.AddField(
            model_name='agenda',
            name='business',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='agenda', to='agenda.Business'),
        ),
        migrations.AddField(
            model_name='agenda',
            name='horario',
